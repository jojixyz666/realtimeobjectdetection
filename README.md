...
- **⚙️ Konfigurasi Berbasis YAML** – Atur seluruh parameter aplikasi (sumber video, model, resolusi, threshold, dsb.) secara modular melalui [config.yaml](file:///d:/Development/pyhton/realtimeobjectdetection/config.yaml) tanpa mengubah kode program.
...
| **[🛠️ Pemecahan Masalah](docs/troubleshooting.md)** | Solusi jika kamera tidak terdeteksi, instalasi error, atau FPS rendah. |
